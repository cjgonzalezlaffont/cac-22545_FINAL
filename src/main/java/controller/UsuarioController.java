        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            switch (action) {
                case "/loginUser":
                    ...
                    response.sendRedirect("/motos/views/usuario/user.jsp");
                    break;
                ...
                case "/createUser":
                    ...
                    response.sendRedirect("/motos/views/usuario/userCreado.jsp");
                    break;
                ...
                case "/viewUser":
                    ...
                    response.sendRedirect("/motos/views/usuario/edicion.jsp");
                    break;
                    
                case "/deleteUser":
                    username = (String) session.getAttribute("actualUsername");
                    
                    if(udao.getBorrable(username)==1){
                        regs_afectados = udao.deleteUser(username);
                        session.setAttribute("isLogin", false);
                        session.setAttribute("actualUsername", "");
                    }
                    
                    response.sendRedirect("/motos/index.jsp");
                    break;
